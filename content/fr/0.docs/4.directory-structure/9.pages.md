...
Si vous souhaitez remplacer le comportement de défilement par défaut de Nuxt.js, consultez l'option [scrollBehavior](/docs/configuration-glossary/configuration-router#scrollbehavior).
