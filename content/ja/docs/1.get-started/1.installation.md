...
:button-link[CodeSandbox で試す]{href=https://codesandbox.io/s/github/nuxt/codesandbox-nuxt/tree/master/ blank}
:button-link[StackBlitz で試す]{href=https://stackblitz.com/github/nuxt/starter/tree/stackblitz blank .mt-1}
