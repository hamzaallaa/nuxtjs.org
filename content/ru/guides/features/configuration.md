...
Некоторые файлы в папках pages/, layouts/, middleware/ или store/ будет игнорироваться при сборке проекта, если названия файлов начинаются со специального префикса ignorePrefix.
