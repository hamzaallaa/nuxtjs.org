export default {
  ...
  sidebar: {
    ads: {
      fallback: {
        ...
        description: 'Permitindo nuxt.org no seu Ad-Blocker, você apoia o nosso trabalho e nos ajuda financeiramente'
      }
    }
  },
  home: {
  ...
  resources: {
    themes: {
      ...
      video_course: 'Iniciar curso'
    }
  },
  sustainability: {
    tiers: {
      mvp_sponsors: 'Apoiadores MVP',
      partners: 'Parceiros',
      sponsors: 'Apoiadores',
      donations: 'Doações'
    },
  ...
  showcases: {
    ...
    firefox_extension: 'Extensão Firefox',
    categories: {
      Featured: 'Vitrine',
